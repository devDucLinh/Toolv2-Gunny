...
DataPara1=40
DataPara2=5
return GetData(Level, DataPara1, DataPara2)*20
end;

if (Level <= 20) then
DataPara1=120
DataPara2=5
return GetData(Level-10, DataPara1, DataPara2)*19
end;

if (Level <= 30) then
DataPara1=240
DataPara2=5
return GetData(Level-20, DataPara1, DataPara2)*18
end;

if (Level <= 40) then
DataPara1=360
DataPara2=5
return GetData(Level-30, DataPara1, DataPara2)*17
end;

if (Level <= 50) then
DataPara1=480
DataPara2=5
return GetData(Level-40, DataPara1, DataPara2)*16
end;

if (Level <= 60) then
DataPara1=600
DataPara2=5
return GetData(Level-50, DataPara1, DataPara2)*15
end;

if (Level <= 70) then
DataPara1=720
DataPara2=5
return GetData(Level-60, DataPara1, DataPara2)*13
end;

if (Level <= 80) then
DataPara1=800
DataPara2=5
return GetData(Level-70, DataPara1, DataPara2)*9
end;

if (Level <= 90) then
DataPara1=900
DataPara2=5
return GetData(Level-80, DataPara1, DataPara2)*4
end;
...
DataPara1=1200
DataPara2=5
return GetData(Level-100, DataPara1, DataPara2)*3
end;
...
DataPara1=2100
DataPara2=60
return GetData(Level-50, DataPara1, DataPara2)*1.1
end;

if (Level <= 70) then
DataPara1=2950
DataPara2=60
return GetData(Level-60, DataPara1, DataPara2)*1.1
end;

if (Level <= 80) then
DataPara1=3500
DataPara2=60
return GetData(Level-70, DataPara1, DataPara2)*1.1
end;

if (Level <= 90) then
DataPara1=5050
DataPara2=60
return GetData(Level-80, DataPara1, DataPara2)*1.1
end;

if (Level <= 100) then
DataPara1=6450
DataPara2=60
return GetData(Level-90, DataPara1, DataPara2)*1.1
end;

if (Level <= 110) then
DataPara1=6450
DataPara2=60
return GetData(Level-100, DataPara1, DataPara2)*1.1
end;
